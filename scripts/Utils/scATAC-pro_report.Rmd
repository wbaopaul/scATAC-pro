...
params:
  ...
  selected_bcs: ~/yuw1/run_scATAC-pro/output/filtered_matrix/cellranger/barcodes.txt
  ...
  downstream_dir: ~/yuw1/run_scATAC-pro/output/downstream_analysis/cellranger
...
cg <- DimPlot(ss, reduction = 'umap', group.by = 'active_clusters') 
