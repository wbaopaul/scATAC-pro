...
echo "do DA..."
${R_PATH}/Rscript --vanilla ${curr_dir}/src/runDA.R $seurat_obj TMP0 $cl1 $cl2 LR 
...
#input_peak=TMP0/select_peaks.bed
input_peak=output/downstream_analysis/FILTER/differential_peak_cluster_table.txt
