...
${R_PATH}/Rscript --vanilla ${curr_dir}/src/integrate_mtx.R $mtx_files $K_CLUSTERS $output_dir $GENOME_NAME $TSS $norm_by $REDUCTION $nREDUCTION $nFeature4Integration $Integrate_By 
