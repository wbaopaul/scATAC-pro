...
region_file=${mat_dir}/${OUTPUT_PREFIX}_bin.bed
...
${PERL_PATH}/perl ${curr_dir}/get_peak_barcode_mat.pl --region_file $region_file --read_file ${mat_dir}/tmp.sam --read_length 100 --output_mat_file ${mat_dir}/${OUTPUT_PREFIX}.bin.barcode_resl${BIN_RESL}.mat  
