...
#  library(grid)
 ...
 p <- ggplot(data = footprint_stats, aes(x = motif, y = TF_Activity, 
   ...
   theme(legend.text = element_text(size=15), 
         ...
         face = 'bold'), panel.background = element_rect(fill = "white")) + ggtitle(paste0('TF Activity difference: cluster', cluster2_fp, '-', 'cluster', cluster1_fp )) + geom_text_repel(force = 10) + 
