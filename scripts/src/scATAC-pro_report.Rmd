...
if(file.exists(go_file)){
   #library(xlsx)
    cls = as.character(unique(ss$active_clusters))
...
if(group1_fp == 'one'){
  comp_cls =  paste0(group1_fp, '_VS_', group2_fp)
}else if(group2_fp == 'rest'){
  comp_cls = paste0('cluster_', group1_fp, '_VS_', group2_fp)
}else{
  comp_cls = paste0('cluster_', group1_fp, '_VS_cluster_', group2_fp)
}


footprint_stats.file = paste0(down.dir, '/differential_TF_footprint_', comp_cls, '.txt')
