#Run as follows:
#perl split_bam.parametric.pl --cluster_file cluster_file --bam_file bam_file --output_dir output_dir --samtools_path SAMTOOLS_PATH
...
print "I am initializing output bam files \n";
...
print "I have found $cluster_counter clusters in your data and initialized one bam file for each of them.\n";
